...
if ( is_single() ): ?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'blog__item white-bg mb-50 transition-3 format-gallery' );?>>
        ...
        <div class="post_gallery owl-carousel">
            ...
            <img src="<?php echo esc_url( $image['full_image_url'] ); ?>" alt="<?php print esc_attr__( 'gallery image', 'educal' );?>">
            <?php endforeach;?>
        </div>
        <?php endif;?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'blog__item white-bg mb-50 transition-3 fix format-gallery' );?> data-wow-delay=".3s">
        <?php if ( !empty( $gallery_images ) ): ?>
        <div class="post_gallery owl-carousel">
            <?php foreach ( $gallery_images as $key => $image ): ?>
            <img src="<?php echo esc_url( $image['full_image_url'] ); ?>" alt="<?php print esc_attr__( 'gallery image', 'educal' );?>">
