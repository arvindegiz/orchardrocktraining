<?php
    ...
    $author_info = get_the_author_meta( 'educal_write_by');
    $facebook_url = get_the_author_meta( 'educal_facebook' );
    $twitter_url = get_the_author_meta( 'educal_twitter' );
    $linkedin_url = get_the_author_meta( 'educal_linkedin' );
    $instagram_url = get_the_author_meta( 'educal_instagram' );
    $educal_url = get_the_author_meta( 'educal_youtube' );
    $educal_write_by = get_the_author_meta( 'educal_write_by' );
