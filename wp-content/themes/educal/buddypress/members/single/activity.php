...
<nav class="<?php bp_nouveau_single_item_subnav_classes(); ?>" id="subnav" role="navigation" aria-label="<?php esc_attr_e( 'Activity menu', 'educal' ); ?>">
	<ul class="subnav">
...
<h2 class="bp-screen-title<?php echo ( bp_displayed_user_has_front_template() ) ? ' bp-screen-reader-text' : ''; ?>">
	<?php esc_html_e( 'Member Activities', 'educal' ); ?>
</h2>
