...
<?php if ( bp_is_group_create() ) : ?>
	...
	<h3 class="bp-screen-title creation-step-name">
		<?php esc_html_e( 'Enter Group Name &amp; Description', 'educal' ); ?>
	</h3>

<?php else : ?>

	<h2 class="bp-screen-title">
		<?php esc_html_e( 'Edit Group Name &amp; Description', 'educal' ); ?>
	</h2>

<?php endif; ?>

<label for="group-name"><?php esc_html_e( 'Group Name (required)', 'educal' ); ?></label>
...
<label for="group-desc"><?php esc_html_e( 'Group Description (required)', 'educal' ); ?></label>
