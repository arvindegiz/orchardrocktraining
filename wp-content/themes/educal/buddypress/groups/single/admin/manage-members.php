...
<h2 class="bp-screen-title <?php if ( bp_is_group_create() ) { echo esc_attr( 'creation-step-name' ); } ?>">
	<?php esc_html_e( 'Manage Group Members', 'educal' ); ?>
</h2>

<p class="bp-help-text"><?php esc_html_e( 'Manage your group members; promote to moderators, admins or demote or ban.', 'educal' ); ?></p>
...
<?php if ( bp_rest_api_is_available() ) :
	...
	<dt class="admin-section section-title"><?php esc_html_e( 'Administrators', 'educal' ); ?></dt>
				...
				<li class="member-entry clearfix">
					...
					<?php if ( count( bp_group_admin_ids( false, 'array' ) ) > 1 ) : ?>
						...
						<p class="action text-links-list">
							<a class="button confirm admin-demote-to-member" href="<?php bp_group_member_demote_link( bp_get_member_user_id() ); ?>"><?php esc_html_e( 'Demote to Member', 'educal' ); ?></a>
						</p>
	...
	<?php if ( bp_group_has_moderators() ) : ?>
		...
		<dt class="moderator-section section-title"><?php esc_html_e( 'Moderators', 'educal' ); ?></dt>
			...
			<ul id="mods-list" class="item-list single-line">
				...
				<li class="members-entry clearfix">
					...
					<div class="members-manage-buttons action text-links-list">
						<a href="<?php bp_group_member_promote_admin_link( array( 'user_id' => bp_get_member_user_id() ) ); ?>" class="button confirm mod-promote-to-admin"><?php esc_html_e( 'Promote to Admin', 'educal' ); ?></a>
						<a class="button confirm mod-demote-to-member" href="<?php bp_group_member_demote_link( bp_get_member_user_id() ); ?>"><?php esc_html_e( 'Demote to Member', 'educal' ); ?></a>
					</div>
	...
	<dt class="gen-members-section section-title"><?php esc_html_e( 'Members', 'educal' ); ?></dt>
