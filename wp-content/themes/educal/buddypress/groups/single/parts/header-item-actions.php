...
<div id="item-actions" class="group-item-actions">
	...
	<?php if ( bp_current_user_can( 'groups_access_group' ) ) : ?>
		...
		<h2 class="bp-screen-reader-text"><?php esc_html_e( 'Group Leadership', 'educal' ); ?></h2>

		<dl class="moderators-lists">
			<dt class="moderators-title"><?php esc_html_e( 'Group Administrators', 'educal' ); ?></dt>
		...
		?>
			...
			<dl class="moderators-lists">
				<dt class="moderators-title"><?php esc_html_e( 'Group Mods', 'educal' ); ?></dt>
