...
<h2 class="bp-screen-title<?php echo ( ! bp_is_group_home() ) ? ' bp-screen-reader-text' : ''; ?>">
	<?php esc_html_e( 'Group Activities', 'educal' ); ?>
</h2>
...
<div class="subnav-filters filters clearfix">
	...
	<ul>
		<?php if ( bp_activity_is_feed_enable( 'group' ) ) : ?>
			<li class="feed">
				<a href="<?php bp_group_activity_feed_link(); ?>" class="bp-tooltip no-ajax" data-bp-tooltip="<?php esc_attr_e( 'RSS Feed', 'educal' ); ?>">
					<span class="bp-screen-reader-text"><?php esc_html_e( 'RSS', 'educal' ); ?></span>
				</a>
			</li>
		<?php endif; ?>
