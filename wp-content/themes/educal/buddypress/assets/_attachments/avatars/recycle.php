	...
	<div class="avatars-history">
		<div class="avatar-history-list">
			<table class="avatar-history-table">
				<thead>
					<tr>
						<th><?php esc_html_e( 'Profile photo', 'educal' ); ?></th>
						<th><?php esc_html_e( 'Uploaded on', 'educal' ); ?></th>
					</tr>
				</thead>
		...
		<div class="avatar-history-actions">
			<p class="warning"><?php esc_html_e( 'Click on a profile photo from your history to recycle it as your current profile photo or delete it.', 'educal' ); ?></p>
			<button class="avatar-history-action recycle disabled">
				<?php esc_html_e( 'Recycle', 'educal' ); ?>
			</button>
			<button class="avatar-history-action delete disabled">
				<?php esc_html_e( 'Delete', 'educal' ); ?>
			</button>
		</div>
	</div>
</script>
