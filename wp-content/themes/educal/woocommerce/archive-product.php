...
if( $_content_layout_style == 'no-sidebar' ) {
    $educal_woo_col = "col-xl-12 col-lg-12";
    $educal_sidebar_col = "d-none";
}
elseif( $_content_layout_style == 'right-sidebar' AND is_active_sidebar('product-sidebar') ) {
    $educal_sidebar_col = "col-xl-3 col-lg-3";
    $educal_woo_col = "col-xl-9 col-lg-9 shop-sidebar-pad order-first";
}
elseif( $_content_layout_style == 'full-width' ) {
    $educal_woo_col = "col-xl-12 col-lg-12";
    $educal_woo_full_container = "container-fluid";
    $educal_sidebar_col = "d-none";
}
elseif( $_content_layout_style == 'default' OR $_content_layout_style == 'left-sidebar' OR is_active_sidebar('product-sidebar') ) {
    $educal_sidebar_col = "col-xl-3 col-lg-3";
    $educal_woo_col = "col-xl-9 col-lg-9 shop-sidebar-pad";
}
else {
    $educal_woo_col = "col-xl-12 col-lg-12";
    $educal_sidebar_col = "d-none";
...
$educal_product_col = "col-lg-". intval($_product_columns) ." col-sm-6 custom-col-10";


if( !empty($_GET['pcol']) ) {
    $educal_product_col = "col-lg-". intval($_GET['pcol']) ." col-sm-6 custom-col-10";
}
        ...
        <div class="container">
            <div class="row">
                <?php if (is_active_sidebar('product-sidebar')): ?>
                    <div class="<?php print esc_attr($educal_sidebar_col); ?>">
                ...
                <?php endif; ?>
                <div class="<?php print esc_attr($educal_woo_col); ?>">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                if (wc_get_loop_prop('total')) {
                                    while (have_posts()) {
                                        ...
                                        print '<div class="col-lg-4 com-md-6">';
                                        /**
